...
@Getter
@RequiredArgsConstructor(access = AccessLevel.PRIVATE) //arg를 받아와서 내부에서 생성(의존성 주입)
public enum ErrorStatus {
    ...
    NOT_FOUND
     */
    NO_USER_EXCEPTION(HttpStatus.NOT_FOUND, "요청받은 사용자를 찾을 수 없습니다."),
    NO_POST_EXCEPTION(HttpStatus.NOT_FOUND, "요청받은 게시물을 찾을 수 없습니다."),
